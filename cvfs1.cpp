...
void man(char *name)
{
    ...
    {
        printf("Description: Used to display all information of file\n");
        printf("Usage:stat File_name Descriptor\n");
    }
    else if(strcmp(name,"truncate")==0)
    {
        printf("Description:Used to removed data from file\n");
    ...
    {
        printf("Desceiption:Used to change file offset\n");
        printf("Usage:lseek File_name ChangeInOffset StartPoint\n");
    }
    else if(strcmp(name,"rm")==0)
    {
        printf("Description:Used to delete all files\n");
        printf("Usage:rm File_name\n");
    }
    else
    {
        printf("ERROR:No mutual entry avaiable\n");
    }
...
void DisplayHelp()
{
    ...
    printf("exit:To terminated file system\n");
...
int rm_file(char*name)
{
    ...
    //  free(UFDTArr[fd].ptrfiletable->ptrinode->Buffer)=0;
...
int fstat_file(int fd)
{
    ...
    printf("\n---------------Staticstical information about file------------------\n");
    printf("File name: %s\n",temp->FileName);
  ...
  int main()
  {
    ...
    while(1)
    {
        ...
        if(Count==1)
        {
            ...
            {
                CloseAllFile();
                printf("Close all file succesfully\n");
                continue;
            }
        ...
        else if(Count==2)
        {
            ...
            else if(strcmp(command[0],"write")==0)
            {
                fd=GetFDFromName(command[1]);
                    ...
                    if(fd==-1)
                    {
                        printf("ERROE:Incorrect parameter\n");
                        continue;
                    }
                    ...
                    if(ret==-2)
                    {
                        printf("ERROR:There is no sufficient memory to write file\n ");
                    }
                    if(ret==-3)
                    {
